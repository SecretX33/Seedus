...
public class Const {
    ...
    public static final String PLUGIN_PERMISSION_PREFIX = "seedus";
    public static final String PLUGIN_COMMAND_PREFIX = "seedus";
    ...
    public static final double LOWER_LIMIT = 0, UPPER_LIMIT = 255;
}
